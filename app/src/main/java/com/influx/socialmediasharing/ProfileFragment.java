package com.influx.socialmediasharing;
...
/**
 * Created by Influx on 8/18/2016.
 */

public class ProfileFragment extends Fragment implements OnRequestSocialPersonCompleteListener {
    private String message = "Android Application Development Tutorial";
    private String link = "http://selvasanthosh.com";
        ...
        public void onClick(View view) {
            ...
            ad.setPositiveButton("Post link", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    postParams.putString(SocialNetwork.BUNDLE_PICTURE, "https://pbs.twimg.com/media/CqG-RReVIAAlFU6.jpg");
